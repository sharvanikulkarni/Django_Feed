...
def friends(request):
    ...
    #to get eligible profiles - exclude user profile, their existing friends, and friends request that are already sent
    ...
    #if this the first time to access the friend requests page, create the first relationship
    ...
    if request.method == "POST" and request.POST.get("receive_requests"):
        ...
        for sender in senders:
            ...
            #crteate a relationship object to access the sender's user id
            ...
            #addd the user to the friends list of the sender's profile
